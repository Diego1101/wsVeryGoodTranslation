...
<form action="traducciones.do" method="post" id="frmLoadMod" name="frmLoadMod">
    <input type="hidden" id="org" name="org" value="loadModTrad">
    <%
                ...
                <tr class="<%=claass%>">
                    ...
                    <td>
                        <form method="post" action="traducciones.do">
                            ...
                            <input type="hidden" name="org" value="modTradSel" id="org">
            ...
            <div class="texto2" style="background:none; display:none; " id="div_ModificarDatos"> <!-- este se tiene que ocultar con la propiedad dislpay none -->
                ...
                <table>
                    ...
                    <tr style="text-align:center">
                        <td colspan="4">
                            <input type="hidden" name="org" value="modDatosTrad" id="org">
                ...
                <table>
                    ...
                    <tr align="center">
                        <td colspan="5">
                            ...
                            <input type="hidden" name="org" value="modDescuentoTrad" id="org">
                ...
                <table>
                    ...
                    <tr align="center">
                        <td colspan="2">
                            ...
                            <input type="hidden" name="org" value="prorrogaTrad" id="org">
